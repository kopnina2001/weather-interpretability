...
RESULTS_DIR = os.path.expanduser('~/weather-interpretability/results/campaign_pangu6_test_v2')
PRED_DIR = os.path.expanduser('~/weather-interpretability/results/campaign_pangu6_test_v2_predictions')
