...
N_STEPS = 8
RESULTS_DIR = os.path.expanduser('~/weather-interpretability/results/campaign_stormer_test_v2')
PRED_DIR = os.path.expanduser('~/weather-interpretability/results/campaign_stormer_test_v2_predictions')
