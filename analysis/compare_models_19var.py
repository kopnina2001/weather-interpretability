...
paths = {
    'aurora': '~/weather-interpretability/results/patching/patching_19var/metrics_19var_aurora.pkl',
    'pangu': '~/weather-interpretability/results/patching/patching_19var_pangu/metrics_19var_pangu.pkl',
}
M = {}
