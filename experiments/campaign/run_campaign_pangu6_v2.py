...
RESULTS_DIR = os.path.expanduser('~/weather-interpretability/results/campaign/campaign_pangu6')
PRED_DIR = os.path.expanduser('~/weather-interpretability/results/campaign/campaign_pangu6_predictions')
