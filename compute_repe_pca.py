...
RESULTS_DIR = os.path.expanduser('~/weather-interpretability/results/skeleton_decomposition')
OUT_PATH = os.path.expanduser('~/weather-interpretability/results/tensor_decomposition/repe_pca.pkl')
