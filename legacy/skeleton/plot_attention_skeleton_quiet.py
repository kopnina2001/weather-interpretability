...
RESULTS_PATH = '/home/irina/weather-interpretability/results/legacy/skeleton_decomposition/quiet_attention.pkl'
...
for stage_idx, stage_data in results['stages'].items():
    ...
    plt.tight_layout()
    plt.savefig(f'{FIG_DIR}/attention_landmarks_quiet_stage{stage_idx}_24h.png', dpi=140, bbox_inches='tight')
    print(f'Saved attention_landmarks_quiet_stage{stage_idx}_24h.png')
