...
# quiet control label -> reference date (verified no cyclone in region via IBTrACS);
# init_time = ref - 1 day, same as the storm cases, for a like-for-like +24h comparison
STORMS = {
    'quiet_2018': np.datetime64('2018-09-22'),
    'quiet_2019': np.datetime64('2019-09-14'),
    'quiet_2021': np.datetime64('2021-09-20'),
    'quiet_2022': np.datetime64('2022-09-20'),
    'quiet_2023': np.datetime64('2023-09-16'),
}
