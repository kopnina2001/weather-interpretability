...
TYPHOON_LAT, TYPHOON_LON = 31.0, 121.5  # approx Shanghai / Bebinca landfall area
STAGES_TO_ANALYZE = [0, 1]  # skip stage2: 45x90 doesn't divide evenly by window (6,12)
OUT_PATH = os.path.expanduser('~/weather-interpretability/results/legacy/skeleton_decomposition/bebinca_attention.pkl')
