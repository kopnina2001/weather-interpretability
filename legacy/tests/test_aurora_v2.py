...
RESULTS_DIR = os.path.expanduser('~/weather-interpretability/results/campaign/campaign_aurora_test_v2')
PRED_DIR = os.path.expanduser('~/weather-interpretability/results/campaign/campaign_aurora_test_v2_predictions')
