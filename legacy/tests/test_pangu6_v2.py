...
(all 13 levels) to results/campaign/campaign_pangu6_predictions/, so future metric/climatology changes don't
...
RESULTS_DIR = os.path.expanduser('~/weather-interpretability/results/campaign/campaign_pangu6_test_v2')
PRED_DIR = os.path.expanduser('~/weather-interpretability/results/campaign/campaign_pangu6_test_v2_predictions')
