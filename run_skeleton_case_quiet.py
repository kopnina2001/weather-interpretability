...
OUT_PATH = os.path.expanduser('~/weather-interpretability/results/skeleton_decomposition/quiet_aurora.pkl')
...
RAW_X_PATH = os.path.expanduser('~/weather-interpretability/results/skeleton_decomposition/quiet_aurora_raw_X.npz')
