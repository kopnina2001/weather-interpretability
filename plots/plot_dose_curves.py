...
for lead in LEADS:
    sub = df[df.lead == lead]
    g = sub.groupby(['output', 'alpha'])['rmse_norm'].mean().unstack()
    ...
    ax.set_ylabel(r'RMSE / $\sigma_w$(правда)', fontsize=11)
    ax.set_title(f'Aurora +{lead}ч: рост ошибки при вливании зашумлённых данных\n'
