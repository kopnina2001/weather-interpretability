...
RESULTS_DIR = os.path.expanduser('~/weather-interpretability/results/campaign_aurora')
PRED_DIR = os.path.expanduser('~/weather-interpretability/results/campaign_aurora_predictions')
